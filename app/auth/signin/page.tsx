    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Sign in to your Frustum account</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input type="password" placeholder="••••••••" value={form.password} onChange={e => setForm(f => ({ ...f, password: e.target.value }))} className="bg-background border-border focus:border-primary/50" required />
            </div>
